--< This code is old, and won't work very good, but here you go. >--
_G.TeamColorEnabled = true
_G.TeamColor = Color3.fromRGB("ColorHere")
_G.EnemyColor = 'default'
